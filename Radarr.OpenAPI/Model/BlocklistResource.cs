...
namespace Radarr.OpenAPI.Model
{
    ...
    public partial class BlocklistResource : IEquatable<BlocklistResource>, IValidatableObject
    {
        ...
        public BlocklistResource(int id = default(int), int movieId = default(int), string sourceTitle = default(string), List<Language> languages = default(List<Language>), QualityModel quality = default(QualityModel), List<CustomFormatResource> customFormats = default(List<CustomFormatResource>), DateTime date = default(DateTime), DownloadProtocol? protocol = default(DownloadProtocol?), string indexer = default(string), string message = default(string), MovieResource movie = default(MovieResource))
        {
            this.Id = id;
