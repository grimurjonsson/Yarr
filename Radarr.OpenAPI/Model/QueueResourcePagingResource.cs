...
namespace Radarr.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QueueResourcePagingResource")]
    public partial class QueueResourcePagingResource : IEquatable<QueueResourcePagingResource>, IValidatableObject
    {
        ...
        public QueueResourcePagingResource(int page = default(int), int pageSize = default(int), string sortKey = default(string), SortDirection? sortDirection = default(SortDirection?), List<PagingResourceFilter> filters = default(List<PagingResourceFilter>), int totalRecords = default(int), List<QueueResource> records = default(List<QueueResource>))
        {
            this.Page = page;
        ...
        {
            return this.Equals(input as QueueResourcePagingResource);
        }
