...
namespace Radarr.OpenAPI.Model
{
    ...
    public partial class SelectOption : IEquatable<SelectOption>, IValidatableObject
    {
        ...
        public SelectOption(int value = default(int), string name = default(string), int order = default(int), string hint = default(string), bool dividerAfter = default(bool))
        {
            this.Value = value;
            this.Name = name;
            this.Order = order;
        ...
        /// </summary>
        [DataMember(Name = "dividerAfter", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as SelectOption);
        }
        ...
        public bool Equals(SelectOption input)
        {
            ...
            return 
                ...
                (
                    this.DividerAfter == input.DividerAfter ||
                    this.DividerAfter.Equals(input.DividerAfter)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.DividerAfter.GetHashCode();
                return hashCode;
            }
        }
