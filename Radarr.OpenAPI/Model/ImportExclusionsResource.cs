...
namespace Radarr.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ImportExclusionsResource")]
    public partial class ImportExclusionsResource : IEquatable<ImportExclusionsResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportExclusionsResource" /> class.
        /// </summary>
        ...
        /// <param name="movieYear">movieYear.</param>
        public ImportExclusionsResource(int id = default(int), string name = default(string), List<Field> fields = default(List<Field>), string implementationName = default(string), string implementation = default(string), string configContract = default(string), string infoLink = default(string), ProviderMessage message = default(ProviderMessage), List<int> tags = default(List<int>), List<ImportExclusionsResource> presets = default(List<ImportExclusionsResource>), int tmdbId = default(int), string movieTitle = default(string), int movieYear = default(int))
        {
            this.Id = id;
            this.Name = name;
            this.Fields = fields;
        ...
        public List<ImportExclusionsResource> Presets { get; set; }
        ...
        /// <summary>
        /// Gets or Sets MovieYear
        /// </summary>
        [DataMember(Name = "movieYear", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportExclusionsResource {\n");
            ...
            sb.Append("  MovieYear: ").Append(MovieYear).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ImportExclusionsResource);
        }

        /// <summary>
        /// Returns true if ImportExclusionsResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ImportExclusionsResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportExclusionsResource input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MovieYear == input.MovieYear ||
                    this.MovieYear.Equals(input.MovieYear)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.MovieYear.GetHashCode();
                return hashCode;
            }
        }
