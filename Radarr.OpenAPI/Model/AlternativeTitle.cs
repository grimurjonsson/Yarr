...
namespace Radarr.OpenAPI.Model
{
    ...
    /// AlternativeTitle
    /// </summary>
    [DataContract(Name = "AlternativeTitle")]
    public partial class AlternativeTitle : IEquatable<AlternativeTitle>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AlternativeTitle" /> class.
        /// </summary>
        ...
        public AlternativeTitle(int id = default(int), SourceType? sourceType = default(SourceType?), int movieMetadataId = default(int), string title = default(string), string cleanTitle = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlternativeTitle {\n");
        ...
        {
            return this.Equals(input as AlternativeTitle);
        }

        /// <summary>
        /// Returns true if AlternativeTitle instances are equal
        /// </summary>
        /// <param name="input">Instance of AlternativeTitle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlternativeTitle input)
        {
            if (input == null)
                return false;
