...
namespace Radarr.OpenAPI.Model
{
    ...
    public partial class Command : IEquatable<Command>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "isTypeExclusive", EmitDefaultValue = true)]
        public bool IsTypeExclusive { get; private set; }

        /// <summary>
        /// Returns false as IsTypeExclusive should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeIsTypeExclusive()
        {
            return false;
        }
        /// <summary>
        ...
        public bool Equals(Command input)
        {
            ...
            return 
                ...
                (
                    this.IsTypeExclusive == input.IsTypeExclusive ||
                    this.IsTypeExclusive.Equals(input.IsTypeExclusive)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.IsTypeExclusive.GetHashCode();
