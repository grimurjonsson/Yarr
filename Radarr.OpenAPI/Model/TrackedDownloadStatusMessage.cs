...
namespace Radarr.OpenAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TrackedDownloadStatusMessage")]
    public partial class TrackedDownloadStatusMessage : IEquatable<TrackedDownloadStatusMessage>, IValidatableObject
    {
        ...
        public TrackedDownloadStatusMessage(string title = default(string), List<string> messages = default(List<string>))
        {
            this.Title = title;
        ...
        {
            return this.Equals(input as TrackedDownloadStatusMessage);
        }
