...
namespace Radarr.OpenAPI.Model
{
    ...
    public partial class ImportListBulkResource : IEquatable<ImportListBulkResource>, IValidatableObject
    {
        ...
        public ImportListBulkResource(List<int> ids = default(List<int>), List<int> tags = default(List<int>), ApplyTags? applyTags = default(ApplyTags?), bool? enableAuto = default(bool?), string rootFolderPath = default(string), int? qualityProfileId = default(int?))
        {
            this.Ids = ids;
            this.Tags = tags;
