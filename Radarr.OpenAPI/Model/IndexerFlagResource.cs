...
namespace Radarr.OpenAPI.Model
{
    ...
    /// IndexerFlagResource
    /// </summary>
    [DataContract(Name = "IndexerFlagResource")]
    public partial class IndexerFlagResource : IEquatable<IndexerFlagResource>, IValidatableObject
    {
        /// <summary>
        ...
        public IndexerFlagResource(int id = default(int), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as IndexerFlagResource);
        }

        /// <summary>
        /// Returns true if IndexerFlagResource instances are equal
        /// </summary>
        /// <param name="input">Instance of IndexerFlagResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IndexerFlagResource input)
        {
            if (input == null)
                return false;
