...
namespace Radarr.OpenAPI.Api
{
    ...
    public interface IReleasePushApiSync : IApiAccessor
    {
        ...
        ReleaseResource ApiV3ReleasePushIdGet(int id);
        ...
        ApiResponse<ReleaseResource> ApiV3ReleasePushIdGetWithHttpInfo(int id);
        /// <summary>
        /// 
        /// </summary>
        /// <exception cref="Radarr.OpenAPI.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface IReleasePushApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ReleaseResource> ApiV3ReleasePushIdGetAsync(int id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ReleaseResource>> ApiV3ReleasePushIdGetWithHttpInfoAsync(int id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class ReleasePushApi : IReleasePushApi
    {
        ...
        /// <returns></returns>
        public ReleasePushApi(Radarr.OpenAPI.Client.Configuration configuration)
        {
        ...
        public ReleasePushApi(Radarr.OpenAPI.Client.ISynchronousClient client, Radarr.OpenAPI.Client.IAsynchronousClient asyncClient, Radarr.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="id"></param>
        /// <returns>ReleaseResource</returns>
        public ReleaseResource ApiV3ReleasePushIdGet(int id)
        {
            Radarr.OpenAPI.Client.ApiResponse<ReleaseResource> localVarResponse = ApiV3ReleasePushIdGetWithHttpInfo(id);
        ...
        /// <param name="id"></param>
        /// <returns>ApiResponse of ReleaseResource</returns>
        public Radarr.OpenAPI.Client.ApiResponse<ReleaseResource> ApiV3ReleasePushIdGetWithHttpInfo(int id)
        {
            ...
            var localVarResponse = this.Client.Get<ReleaseResource>("/api/v3/release/push/{id}", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiV3ReleasePushIdGet", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ReleaseResource</returns>
        public async System.Threading.Tasks.Task<ReleaseResource> ApiV3ReleasePushIdGetAsync(int id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Radarr.OpenAPI.Client.ApiResponse<ReleaseResource> localVarResponse = await ApiV3ReleasePushIdGetWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ReleaseResource)</returns>
        public async System.Threading.Tasks.Task<Radarr.OpenAPI.Client.ApiResponse<ReleaseResource>> ApiV3ReleasePushIdGetWithHttpInfoAsync(int id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ReleaseResource>("/api/v3/release/push/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Radarr.OpenAPI.Client.ApiResponse<List<ReleaseResource>> localVarResponse = ApiV3ReleasePushPostWithHttpInfo(releaseResource);
            return localVarResponse.Data;
        }
        ...
        /// <param name="releaseResource"> (optional)</param>
        /// <returns>ApiResponse of List&lt;ReleaseResource&gt;</returns>
        public Radarr.OpenAPI.Client.ApiResponse<List<ReleaseResource>> ApiV3ReleasePushPostWithHttpInfo(ReleaseResource releaseResource = default(ReleaseResource))
        {
            Radarr.OpenAPI.Client.RequestOptions localVarRequestOptions = new Radarr.OpenAPI.Client.RequestOptions();
        ...
        {
            Radarr.OpenAPI.Client.ApiResponse<List<ReleaseResource>> localVarResponse = await ApiV3ReleasePushPostWithHttpInfoAsync(releaseResource, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ReleaseResource&gt;)</returns>
        public async System.Threading.Tasks.Task<Radarr.OpenAPI.Client.ApiResponse<List<ReleaseResource>>> ApiV3ReleasePushPostWithHttpInfoAsync(ReleaseResource releaseResource = default(ReleaseResource), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
