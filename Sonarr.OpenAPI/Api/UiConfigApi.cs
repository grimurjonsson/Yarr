...
namespace Sonarr.OpenAPI.Api
{
    ...
    public partial class UiConfigApi : IUiConfigApi
    {
        ...
        /// <returns></returns>
        public UiConfigApi(Sonarr.OpenAPI.Client.Configuration configuration)
        {
        ...
        public UiConfigApi(Sonarr.OpenAPI.Client.ISynchronousClient client, Sonarr.OpenAPI.Client.IAsynchronousClient asyncClient, Sonarr.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource> localVarResponse = ApiV3ConfigUiGetWithHttpInfo();
        ...
        /// <exception cref="Sonarr.OpenAPI.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of UiConfigResource</returns>
        public Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource> ApiV3ConfigUiGetWithHttpInfo()
        {
        ...
        {
            Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource> localVarResponse = await ApiV3ConfigUiGetWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UiConfigResource)</returns>
        public async System.Threading.Tasks.Task<Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource>> ApiV3ConfigUiGetWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource> localVarResponse = ApiV3ConfigUiIdGetWithHttpInfo(id);
            return localVarResponse.Data;
        }
        ...
        /// <param name="id"></param>
        /// <returns>ApiResponse of UiConfigResource</returns>
        public Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource> ApiV3ConfigUiIdGetWithHttpInfo(int id)
        {
            Sonarr.OpenAPI.Client.RequestOptions localVarRequestOptions = new Sonarr.OpenAPI.Client.RequestOptions();
        ...
        {
            Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource> localVarResponse = await ApiV3ConfigUiIdGetWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UiConfigResource)</returns>
        public async System.Threading.Tasks.Task<Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource>> ApiV3ConfigUiIdGetWithHttpInfoAsync(int id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource> localVarResponse = ApiV3ConfigUiIdPutWithHttpInfo(id, uiConfigResource);
            return localVarResponse.Data;
        }
        ...
        /// <param name="uiConfigResource"> (optional)</param>
        /// <returns>ApiResponse of UiConfigResource</returns>
        public Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource> ApiV3ConfigUiIdPutWithHttpInfo(string id, UiConfigResource uiConfigResource = default(UiConfigResource))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Sonarr.OpenAPI.Client.ApiException(400, "Missing required parameter 'id' when calling UiConfigApi->ApiV3ConfigUiIdPut");
        ...
        {
            Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource> localVarResponse = await ApiV3ConfigUiIdPutWithHttpInfoAsync(id, uiConfigResource, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UiConfigResource)</returns>
        public async System.Threading.Tasks.Task<Sonarr.OpenAPI.Client.ApiResponse<UiConfigResource>> ApiV3ConfigUiIdPutWithHttpInfoAsync(string id, UiConfigResource uiConfigResource = default(UiConfigResource), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Sonarr.OpenAPI.Client.ApiException(400, "Missing required parameter 'id' when calling UiConfigApi->ApiV3ConfigUiIdPut");
