...
namespace Sonarr.OpenAPI.Api
{
    ...
    public interface IParseApiSync : IApiAccessor
    {
        ...
        ParseResource ApiV3ParseGet(string title = default(string), string path = default(string));
        ...
        ApiResponse<ParseResource> ApiV3ParseGetWithHttpInfo(string title = default(string), string path = default(string));
    ...
    public interface IParseApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ParseResource> ApiV3ParseGetAsync(string title = default(string), string path = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ParseResource>> ApiV3ParseGetWithHttpInfoAsync(string title = default(string), string path = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ParseApi : IParseApi
    {
        ...
        /// <returns></returns>
        public ParseApi(Sonarr.OpenAPI.Client.Configuration configuration)
        {
        ...
        public ParseApi(Sonarr.OpenAPI.Client.ISynchronousClient client, Sonarr.OpenAPI.Client.IAsynchronousClient asyncClient, Sonarr.OpenAPI.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="path"> (optional)</param>
        /// <returns>ParseResource</returns>
        public ParseResource ApiV3ParseGet(string title = default(string), string path = default(string))
        {
            Sonarr.OpenAPI.Client.ApiResponse<ParseResource> localVarResponse = ApiV3ParseGetWithHttpInfo(title, path);
        ...
        /// <param name="path"> (optional)</param>
        /// <returns>ApiResponse of ParseResource</returns>
        public Sonarr.OpenAPI.Client.ApiResponse<ParseResource> ApiV3ParseGetWithHttpInfo(string title = default(string), string path = default(string))
        {
            ...
            if (title != null)
            {
                localVarRequestOptions.QueryParameters.Add(Sonarr.OpenAPI.Client.ClientUtils.ParameterToMultiMap("", "title", title));
            }
            if (path != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ParseResource</returns>
        public async System.Threading.Tasks.Task<ParseResource> ApiV3ParseGetAsync(string title = default(string), string path = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Sonarr.OpenAPI.Client.ApiResponse<ParseResource> localVarResponse = await ApiV3ParseGetWithHttpInfoAsync(title, path, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ParseResource)</returns>
        public async System.Threading.Tasks.Task<Sonarr.OpenAPI.Client.ApiResponse<ParseResource>> ApiV3ParseGetWithHttpInfoAsync(string title = default(string), string path = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
