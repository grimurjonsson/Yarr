...
namespace Sonarr.OpenAPI.Model
{
    ...
    public partial class ManualImportResource : IEquatable<ManualImportResource>, IValidatableObject
    {
        ...
        public ManualImportResource(int id = default(int), string path = default(string), string relativePath = default(string), string folderName = default(string), string name = default(string), long size = default(long), SeriesResource series = default(SeriesResource), int? seasonNumber = default(int?), List<EpisodeResource> episodes = default(List<EpisodeResource>), int? episodeFileId = default(int?), string releaseGroup = default(string), QualityModel quality = default(QualityModel), List<Language> languages = default(List<Language>), int qualityWeight = default(int), string downloadId = default(string), List<CustomFormatResource> customFormats = default(List<CustomFormatResource>), int customFormatScore = default(int), List<Rejection> rejections = default(List<Rejection>))
        {
            this.Id = id;
            this.Path = path;
        ...
        /// </summary>
        [DataMember(Name = "episodeFileId", EmitDefaultValue = true)]
