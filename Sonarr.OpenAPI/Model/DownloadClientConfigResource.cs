...
namespace Sonarr.OpenAPI.Model
{
    ...
    public partial class DownloadClientConfigResource : IEquatable<DownloadClientConfigResource>, IValidatableObject
    {
        ...
        public DownloadClientConfigResource(int id = default(int), string downloadClientWorkingFolders = default(string), bool enableCompletedDownloadHandling = default(bool), bool autoRedownloadFailed = default(bool))
        {
            this.Id = id;
