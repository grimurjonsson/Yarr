...
namespace Sonarr.OpenAPI.Model
{
    ...
    public partial class UiConfigResource : IEquatable<UiConfigResource>, IValidatableObject
    {
        ...
        public UiConfigResource(int id = default(int), int firstDayOfWeek = default(int), string calendarWeekColumnHeader = default(string), string shortDateFormat = default(string), string longDateFormat = default(string), string timeFormat = default(string), bool showRelativeDates = default(bool), bool enableColorImpairedMode = default(bool), string theme = default(string), int uiLanguage = default(int))
        {
            this.Id = id;
